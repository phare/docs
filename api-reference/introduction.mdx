...
To access the Phare API, you will need to create an API key with the right accesses, this can be done in your <a href="https://app.phare.io/organization/api-keys" rel="nofollow">control panel</a>.
