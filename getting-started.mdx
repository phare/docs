...
If you go with the Scale plan, you'll be prompted for your payment method. This data is not stored or even accessible by Phare, and is managed by our payment provider Paddle.
