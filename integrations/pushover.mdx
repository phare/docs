...
The Pushover integration allows you to send alert on your preferred device using the Pushover app. You can find and configure it in the <a href="https://app.phare.io/organization/apps" rel="nofollow">integration</a> section of your dashboard.
