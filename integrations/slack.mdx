...
Phare only shares the minimum information needed with Slack to deliver your notifications. Phare stores your workspace name, identifier, and an access token for sending messages. For the full details on how your data are handled, take a look at the [privacy policy](https://phare.io/legal/privacy-policy).
