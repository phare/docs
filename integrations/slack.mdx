...
The Phare integration for Slack allows you to send alerts on a Slack workspace channel.

## Installation

To integrate Phare with your Slack workspace, browse the list of <a href="https://app.phare.io/organization/apps" rel="nofollow">available integrations</a>, select Slack, and click on the **New installation** button.
...
You can configure a single Slack channel per integration, and create as many integrations as needed to receive alerts on multiple Slack channels. When installing the Phare integration for Slack you will be redirected to Slack to authorize the Phare application to send messages to your Slack workspace.
...
When an alert rule using the Phare integration for Slack is triggered, a message will be sent to the selected Slack channel. You can find out more about alert policies in the [alerting documentation](/uptime/alerting).
