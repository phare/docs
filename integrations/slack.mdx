...
When an alert policy using the Slack integration is triggered, a message will be sent to the selected Slack channel. You can find out more about alert policies in the [alerting documentation](/uptime/alerting).
