...
Need alerts in different Discord channels? No problem! You can create multiple Discord integrations, each pointing to a specific channel. When you set up a Discord integration, you will be redirected to Discord to authorize the Phare app an select the right Discord server and channel for your alerts.
