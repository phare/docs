...
The Discord integration allows you to send alert on a Discord server channel. You can find and configure it in the [integration](https://app.phare.io/organization/apps) section of your dashboard.
