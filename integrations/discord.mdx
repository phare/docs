...
If the integration is experiencing error or if an update is available, you will be able to reinstall your Discord integration with a single click. This will redirect you to Discord to reauthorize the Phare app and select the right server, channel and up-to-date permissions. Your alert rules will remain unchanged.
