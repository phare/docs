...
Phare plays nicely other tools, making it easy to integrate with your preferred apps and services. Wether you want to receive alerts in your favorite chat app, or send JSON data to a third-party service, you should be covered.
...
Alert integrations are notification channel that can be used when configuring [alert rules](/uptime/alerting). By choosing the right integration for each alert rule, you can make sure the right people get notified on their preferred platforms.
...
<CardGroup cols={2}>
    <Card
        ...
        horizontal
    />
    <Card title="Email" icon="envelope" href="/integrations/email" horizontal />
    <Card
