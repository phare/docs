...
Each country requires specific compliance that Phare need to go through, [Contact the Phare support](https://phare.io/contact) to request adding a new country.
