...
<Frame>
    <iframe
        ...
        height="396"
        frameborder="0"
        title="Phare uptime monitoring demo"
        src="https://iframe.mediadelivery.net/embed/238508/9f92680b-95ac-4e87-80b4-bb7eb65f8fec?autoplay=false&loop=false&muted=false&preload=true&responsive=true"
        loading="lazy"
...
Schedule maintenance windows in advance, pause or mute monitoring checks, and keep your customers informed.

[Learn more about maintenance windows](/uptime/maintenance-windows).

<Frame>
    <img
        src="/images/uptime/overview/maintenance-windows-page.webp"
        alt="Maintenance window shown on a Phare status page"
    />
</Frame>
