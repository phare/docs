...
| Event | API format | Description |
| :--- | :--- | :--- |
| Maintenance window in progress | `uptime.maintenance_window.in_progress` | Sent when a maintenance window starts, notifying teams that planned downtime has begun. |
| Maintenance window completed | `uptime.maintenance_window.completed` | Sent when a maintenance window is finished, confirming normal operations have resumed. |
| Maintenance window cancelled | `uptime.maintenance_window.cancelled` | Sent when a scheduled or in-progress maintenance window is cancelled. |
