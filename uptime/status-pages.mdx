...
| TXT  | status.example.com | Bunny Support - Phare |
    ...
    <Step title="Verify your custom domain">
        Once the ticket is resolved, go back to your <a href="https://app.phare.io/uptime/status-pages" rel="nofollow">status page dashboard</a> and click the `Verify again` button to activate your custom domain.
    </Step>
</Steps>
