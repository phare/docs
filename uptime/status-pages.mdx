...
>
>I'm using Phare.io to host a status page on my subdomain status.example.com, and they need your authorization to generate the SSL certificate. Could you please allow them to do so?
>
