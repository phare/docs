...
3. Wait about 5 minutes for the ticket to be processed by one of their great support agents.

Once the validation is done, you can configure the CNAME record as shown on the following screenshot:
