...
<Steps>
    <Step title="Create a TXT record">
        Add this TXT record to your root domain (`@`) in your DNS settings to help Bunny.net verify your request:

| Type | Name               | Target                |
| :--- | :----------------- | :-------------------- |
| TXT  | @ (or example.com) | Bunny Support - Phare |
    ...
    <Step title="Write a message">
        ...
        Phare.io is also using Bunny, and they need your authorization to add my subdomain on their PullZone and generate an SSL certificate for my subdomain. Could you please whitelist my domain for multi-use across the bunny platform? I've created a TXT record on my root domain called `Bunny Support - Phare` as proof of ownership.
...
<Frame>
    <img
        src="/images/uptime/status-pages/status-page-groups.avif"
        alt="Status page component groups"
    />
</Frame>

To keep status pages organized and readable, you can group multiple monitors into collapsible **groups** (for example, grouping by service, region, or infrastructure layer). Each group displays an aggregated operational status, overall availability, and combined incident history across all nested monitors, with an option to display the group expanded or collapsed by default.

## Monitor display name

You can assign a custom display name to any monitor to show a user-friendly label on your public status page without having to rename the underlying monitor in your dashboard.
...
<Frame>
    <img
        src="/images/uptime/status-pages/access-control-ip.avif"
        alt="Access control ips"
    />
</Frame>
...
<Frame>
    <img
        src="/images/uptime/status-pages/access-control-token.avif"
        alt="Access control token"
    />
</Frame>
...
<Frame>
    <img
        src="/images/uptime/status-pages/access-control-password.avif"
        alt="Access control password"
    />
</Frame>
