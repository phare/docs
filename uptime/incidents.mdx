...
Sometimes you need to create an incident even when your monitors haven't detected a problem. Issues from services you're not actively monitoring, or that can't be monitored by an uptime agent.
...
This feature is powered by [Mistral Small 4](https://mistral.ai/news/mistral-small-4), a lightweight model that provide fast reasoning with lower costs and energy use.
