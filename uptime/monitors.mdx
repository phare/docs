...
IP filtering is not reliable as the Phare Uptime monitoring agent is deployed on [Bunny.net's global network](https://bunnycdn.com/api/system/edgeserverlist), meaining that IPs could be shared with other Bunny.net customers.
