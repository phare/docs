...
<Update label="September 2026">
    <Frame>
        <img src="/images/changelog/131-status-page-display-name.avif" alt="Status page monitor display name" />
    </Frame>

    ## Monitor display names on status pages

    You can now define a custom **Display name** for each monitor on your status page, allowing you to have technical internal monitor name while keeping your status page user friendly.

    <br/>

    ## Hide response times on status pages

    Status pages display the 75th percentile (P75) response time over the last 7 days next to each monitor by default. You can now toggle off **Response times** in your status page settings to hide them completely.
</Update>

<Update label="August 2026">
    <Frame>
        <img src="/images/changelog/130-maintenance-windows.avif" alt="Status page component groups" />
    </Frame>

    ## Scheduled maintenance windows

    You can now plan and schedule maintenance windows in advance to avoid false alarms, keep your SLA metrics accurate, and more importantly keep your customers informed during planned downtime.

    Maintenance windows can be configured with different monitoring mode:
    - **Pause**: Halts monitoring checks during the maintenance window so no requests hit your servers.
    - **Mute**: Keeps checks running and collects performance data in the background, but suppresses all notification channels to prevent alert fatigue.
    - **Normal**: Nothing changes during maintenance windows, you get alerted of incidents as usual.

    Maintenance windows can be linked to multiple status page at once to cover advanced use. Public and private status pages now automatically display upcoming notices for maintenance windows.

    Explore the new [maintenance windows feature](/uptime/maintenance-windows) to learn more.
</Update>

<Update label="July 2026">
    <Frame>
        <img src="/images/changelog/129-status-page-component-groups.avif" alt="Status page component groups" />
    </Frame>

    ## Status pages component groups

    You can now organize your monitors into customizable, collapsible groups (such as "API Services" or "Databases") to give visitors a clearer view of system health.

    Drag and drop monitors into groups, reorder sections on the fly, and collapse groups directly on your public status pages.

    Read the [status pages documentation](/uptime/status-pages) to learn more.
</Update>

<Update label="June 2026">
    ## Data processing agreement (DPA)

    A formal Data Processing Agreement (DPA) is now publicly available to help customers meet GDPR compliance requirements when using Phare without having to submit a formal request.

    Read the full [Data Processing Agreement](https://phare.io/legal/data-processing-agreement) to learn more.
</Update>

<Update label="May 2026">
    <Frame>
        <img src="/images/changelog/128-private-status-pages.avif" alt="Private status pages" />
    </Frame>
    ...
    <Frame>
        <img src="/images/changelog/127-ordering.avif" alt="Ordering datatables" />
    </Frame>
    ...
    <Frame>
        <img src="/images/changelog/126-mistral-small-4.avif" alt="Mistral Small 4 model" />
    </Frame>
...
<Update label="April 2026">
    <Frame>
        <img src="/images/changelog/125-partial-api-update.avif" alt="Partial API updates" />
    </Frame>
    ...
    <Frame>
        <img src="/images/changelog/124-region-threshold.avif" alt="Custom region threshold" />
    </Frame>
...
<Update label="March 2026">
    <Frame>
        <img src="/images/changelog/123-dark-light-logo.avif" alt="Support for dark and light status page logo" />
    </Frame>
    ...
    <Frame>
        <img src="/images/changelog/122-upgraded-ilert.avif" alt="List of available ilert alert rules" />
    </Frame>
    ...
    <Frame>
        <img src="/images/changelog/121-single-region-failure.avif" alt="Single region failure" />
    </Frame>
    ...
    <Frame>
        <img src="/images/changelog/120-2fa-recovery-codes.avif" alt="2fa recovery codes" />
    </Frame>
...
<Update label="February 2026">
        <Frame>
        <img src="/images/changelog/119-dark-status-pages.avif" alt="Dark theme status pages" />
    </Frame>
    ...
    <Frame>
        <img src="/images/changelog/118-uptime-monitor-incidents.avif" alt="Incident data table of a monitor" />
    </Frame>
    ...
    <Frame>
        <img src="/images/changelog/117-terraform-provider-phare-beta.avif" alt="Terraform provider Phare in beta" />
    </Frame>
    ...
    <Frame>
        <img src="/images/changelog/116-incident-updates-endpoints.avif" alt="New incident updates API endpoints" />
    </Frame>
