...
<Update label="May 2026">
    ...
    Grant automatic access to specific IPv4 addresses or CIDR ranges. Requests from listed addresses bypass all other checks, making it the most seamless option for office networks or VPN exit nodes.
