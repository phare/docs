...
<Frame type="glass">
    <img class="border rounded-lg" src="/images/changelog/64-status-badges.webp" alt="Status badges" />
</Frame>
...
<Frame type="glass">
    <img class="border rounded-lg" src="/images/changelog/63-test-notifications.webp" alt="Test notifications" />
</Frame>
...
<Frame type="glass">
    <img class="border rounded-lg" src="/images/changelog/62-pushover-integration.webp" alt="Pushover integration" />
</Frame>
