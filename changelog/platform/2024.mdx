...
If you're interested in learning more about how Phare generates the performance chart, read the article on [downsampling time series data](https://phare.io/blog/downsampling-time-series-data/).
