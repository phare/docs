...
<Frame type="glass">
    <img class="border rounded-lg" src="/images/changelog/80-monitor-certificate-expiring-alert-rule.webp" alt="Monitor certificate expiring alert rule" />
</Frame>

---

## SSL certificate tracking is now built into Phare
_May 1st, 2025_
...
But that's not all, you can also set up a new alert rule to get notified when a new certificate is discovered on any monitor. It's a great way to make sure they're getting renewed on time.

<Frame type="glass">
    <img class="border rounded-lg" src="/images/changelog/79-monitor-certificate-discovered.webp" alt="Monitor certificate discovered notification" />
</Frame>
...
<Frame type="glass">
    <img class="border rounded-lg" src="/images/changelog/78-alerting-system.webp" alt="New alerting system" />
</Frame>
...
<Frame type="glass">
    <img class="border rounded-lg" src="/images/changelog/77-recipient-delivery-logs.webp" alt="Recipient delivery logs" />
</Frame>
