...
<Update label="December 2025">
    <Frame>
        <img src="/images/changelog/105-open-metrics.webp" alt="Open metrics" />
    </Frame>

    ## Public growth metrics

    Phare now share growth metrics openly, you can follow the journey with live user registration stats, monthly uptime monitoring checks, detailed revenues and cost breakdown.

    Visit th [open metrics page](https://phare.io/open).
</Update>

<Update label="November 2025">
    <Frame>
        <img src="/images/changelog/104-france-region.webp" alt="France region" />
    </Frame>
